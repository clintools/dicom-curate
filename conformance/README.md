...
|-----------|------|---------------------|
| `baselines/synthetic/` | `valid-image-0`, `invalid-uid-image-1`, `vendor-warnings-image-2`, and `violation-<class>` per declared violation class | Generated by `dicom-synth` into a temp dir (not committed) |
